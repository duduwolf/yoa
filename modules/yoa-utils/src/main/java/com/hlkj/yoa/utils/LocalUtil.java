...
public final class LocalUtil
{
    ...
    /**
     * URL decode a value.
     * {@link java.net.URLDecoder#decode(String, String)} throws an
     * {@link java.io.UnsupportedEncodingException}, which is silly given that the most
    ...
    /**
     * URL encode a value.
     * {@link java.net.URLEncoder#encode(String, String)} throws an
     * {@link java.io.UnsupportedEncodingException}, which is silly given that the most
     * common use case will be to pass in "UTF-8"
     * @param value The string to decode
     * @return The decoded string
